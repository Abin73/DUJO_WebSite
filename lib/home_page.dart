import 'package:dujo_web/school_profile.dart';
import 'package:dujo_web/web_signin.dart';
                ...
                Stack(children: [
                  ...
                  Row(children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(top: screenSize.width * 1 / 10),
                      child: Column(
                        children: [
                          // SizedBox(height: 10),
                          // InkWell(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        InkWell(
                            onTap: () {},
                            child: Text("Lepton DuJo Schools ",
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                  ...
                  InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Create School Profile",
                              style: TextStyle(
                                color: Colors.white,
